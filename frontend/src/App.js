      ...
      <Card className="bg-gradient-to-br from-violet-600/20 to-pink-600/20 border-violet-500/30 p-6 mb-6">
        ...
        <div className="flex gap-2">
          <Button
            ...
            className="flex-1 bg-[#25D366] hover:bg-[#128C7E] rounded-full"
          ...
          <Button
            ...
            className="flex-1 bg-gradient-to-r from-violet-600 to-pink-600 hover:from-violet-700 hover:to-pink-700 rounded-full"
