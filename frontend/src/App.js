...
const AppContent = () => {
  ...
  const fullScreenPages = ["/watch", "/admin", "/admin/login", "/business", "/help", "/about", "/terms", "/privacy", "/careers", "/press", "/safety", "/guidelines", "/accessibility", "/cookies", "/dmca", "/creator-guidelines", "/revenue", "/contact", "/welcome", "/creator", "/creator/super"];
  ...
  return (
    <div className={`min-h-screen bg-background text-white ${isDesktop ? "w-full" : "max-w-md mx-auto"} relative`}>
      ...
      <Routes>
        ...
        <Route path="/creator/:creatorId/shop" element={<CreatorShopPage />} />
        <Route path="/creator/:creatorId/shop/:itemId" element={<CreatorShopPage />} />
      ...
      {/* AI Support Chat Widget - Has internal logic for when to show */}
      <SupportChatWidget />
