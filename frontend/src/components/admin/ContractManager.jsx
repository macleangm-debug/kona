...
import { 
  ...
  ChevronDown, ChevronRight, Printer, Edit, Copy
} from "lucide-react";
...
export const ContractManager = ({ token }) => {
  ...
  const resetForm = () => {
    setForm({
      ...
      creator_tax_id: "",
      creator_company: "",
      platform_name: platformDefaults?.name || "Kona Streaming Platform",
      platform_email: platformDefaults?.email || "partnerships@kona.com",
      platform_address: "",
      platform_tax_id: "",
      platform_company: platformDefaults?.company_name || "Kona Media Inc.",
      platform_fee: 25,
      creator_share: 60,
      platform_share: 40,
      min_payout: 50,
